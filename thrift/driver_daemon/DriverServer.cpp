...
namespace c4
{
    DriverServer::DriverServer(const std::string& socketPath, const std::string& clientPath) :
        path_(socketPath),
        handler_(boost::make_shared<DriverServiceHandler>(clientPath)),
        processor_(boost::make_shared<DriverServiceProcessor>(handler_)),
